(function() {
  ...
  this.Universe = (function() {
    ...
    function Universe(params) {
      ...
      this.framerate = params.framerate || 60;
    ...
    Universe.prototype.checkCollisions = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        object = _ref[_i];
        object.top_edge = this.scale * object.y();
        object.right_edge = this.scale * object.x() + object.width;
        object.bottom_edge = this.scale * object.y() - object.height;
        object.left_edge = this.scale * object.x();
        _results.push(object.top_edge >= object.universe.space.clientHeight ? object.velocity.y = object.velocity.y * -1 : object.bottom_edge <= 0 ? object.velocity.y = object.velocity.y * -1 : object.left_edge <= 0 ? object.velocity.x = object.velocity.x * -1 : object.right_edge >= object.universe.space.clientWidth ? object.velocity.x = object.velocity.x * -1 : void 0);
      }
      return _results;
    };
    return Universe;
